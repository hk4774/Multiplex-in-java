    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (obj1 == null || obj2 == null || obj3 == null || obj4 == null || obj5 == null || obj6 == null) {
                JOptionPane.showMessageDialog(this, "Please Select movie from List");
            } else {
                admin_frame.jdpDesktop.remove(login.sf);
                admin_frame.jdpDesktop.add(login.bookfrm);
                this.setVisible(false);
                login.bookfrm.setVisible(true);
                login.bookfrm.getSearchData(obj1, obj2, obj3);
            }
